...
(function () {
  ...
  //为原型添加方法---小蛇动起来
  Snake.prototype.move = function (a, map) {
    //改变小蛇的身体的坐标位置
...
(function () {
  ...
  Game.prototype.init = function () {
    //初始化游戏
    //食物初始化
    this.a.init(this.map);
    //小蛇初始化
    this.snake.init(this.map);
    //调用自动移动小蛇的方法========================||调用了小蛇自动移动的方法
    this.runSnake(this.a, this.map);
    //调用按键的方法
    this.bindKey();//========================================
  };

  //添加原型方法---设置小蛇可以自动的跑起来
  Game.prototype.runSnake = function (a, map) {

    //自动的去移动
    var timeId = setInterval(function () {
      //此时的this是window
      //移动小蛇
      this.snake.move(a, map);
      //初始化小蛇
      this.snake.init(map);
      //横坐标的最大值
